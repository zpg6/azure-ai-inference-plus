...
class TestCallbackIntegration:
    ...
    def test_chat_retry_callback_invoked(self):
        ...
        assert first_call['attempt'] == 2  # attempt numbers are 1-based, callback shows next attempt
    ...
    def test_json_retry_callback_invoked(self):
        ...
        retry_function = retry_with_config(config, json_validation=False)(json_failing_function)
        ...
        assert len(chat_callback_calls) == 0  # Chat callback should not be called for JSON errors
